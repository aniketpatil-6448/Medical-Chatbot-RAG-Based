...
const App = () => {
  ...
  const generateResponse = async (conversation, botMessageId) => {
    ...
    try {
      ...
      const responseText = data.answer?.trim() || "No response.";
      ...
      <main className="main-container">
        ...
        {currentConversation.messages.length === 0 ? (
          ...
          <div className="welcome-container">
            <img className="welcome-logo" src="public/codeved_logo.jpg" alt="codeved Logo" />
            <h1 className="welcome-heading">Message CodeVed</h1>
            <p className="welcome-text">Ask me about Medical Domain. I'm here to help!</p>
          </div>
        ) : (
          // Messages container
        ...
        <div className="prompt-container">
          ...
          <p className="disclaimer-text">CodeVed can make mistakes, so double-check it.</p>
        </div>
      </main>
    </div>
  );
